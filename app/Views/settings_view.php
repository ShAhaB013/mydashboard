...
<div class="admin-wrap">
  ...
  <div class="add-asset-form">
    ...
    <div class="settings-grid" style="margin-top:12px;">
      ...
      <div class="field">
        ...
        <div class="pass-wrap">
          ...
          <button type="button" class="pass-toggle" aria-label="نمایش/مخفی" data-act="togglePass" data-target="setSmtpPass">
    ...
    <div class="set-section-title" style="margin-top:16px;">زمان‌بندی کد OTP</div>
